...
# NOTE: APIM-scoped alerts (res-3910..3914) use scope_key "apim_ldapim-prod-eastus" — resolved
#       via module.apim for_each outputs (main.tf line 248). No old-estate ARM paths remain.
alerts = {
  # --- AGW alerts (4) ---
  "prod-agw-5xx" = {
  ...
  # scope_key "apim_ldapim-prod-eastus" resolved via module.apim for_each output (main.tf line 248).
  # Fixed: was "apim_prod" pointing to stale V2 estate ARM path. Now targets new-estate module output.
  "prod-apim-cpu" = {
    name             = "V2 Prod APIM CPU Percentage of Gateway"
    scope_key        = "apim_ldapim-prod-eastus"
...
# Additional alert scope IDs beyond those auto-generated by module outputs.
# APIM prod alert scopes are now resolved directly from module.apim for_each outputs
# (scope keys "apim_ldapim-prod-eastus", "apim_ldapim-prod-stv2-eastus", "apim_apim-staging-eastus"
# are generated by main.tf line 248 via `{ for inst_name, apim_inst in module.apim : "apim_${inst_name}" => apim_inst.gateway_id }`).
# No additional static scope IDs are needed for prod.
